...
public class Berkley {
    ...
    // Method to calculate time difference between two times
    ...
    // Method to calculate average time difference
    ...
    public static void main(String[] args) throws IOException {
        ...
        // Send time from Time Server to each node
        for (int i = 0; i < n; i++) {
